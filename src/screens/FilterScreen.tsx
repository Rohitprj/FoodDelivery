...
const FilterScreen: React.FC<FilterScreenProps> = ({navigation}) => {
  ...
  const sortOptions = ['Relevance', 'Distance', 'Price Low to High', 'Price High to Low'];
  const rangeOptions = ['Veg / Non-Veg', 'Rating', 'Cost: Low to High', 'Cost: High to Low'];
              ...
              <TouchableOpacity
                ...
                <View style={styles.radioContainer}>
                  <View style={[
                    ...
                    {selectedRange === option && <View style={styles.radioInner} />}
                  </View>
                  <Text style={styles.optionText}>{option}</Text>
                </View>
              </TouchableOpacity>
