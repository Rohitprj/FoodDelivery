      ...
      <View style={styles.content}>
              ...
              <View key={item.id} style={styles.cartItem}>
                ...
                <View style={styles.quantityContainer}>
                  <TouchableOpacity 
                    ...
                    onPress={() => item.setQuantity(Math.max(1, item.quantity - 1))}>
            ...
            {coupons.map((coupon, index) => (
              <View key={index} style={styles.couponItem}>
                ...
                <TouchableOpacity 
                  ...
                  onPress={() => coupon.status === 'APPLY' && setShowSuccessModal(true)}>
                  <Text style={[
        ...
        <View style={styles.bottomSection}>
          ...
          <View style={styles.deliveryOptions}>
            ...
            <TouchableOpacity style={[styles.deliveryOption, styles.pickupOption]}>
              <Text style={[styles.deliveryOptionText, styles.pickupOptionText]}>SELF PICKUP</Text>
            </TouchableOpacity>
          </View>

          <TouchableOpacity style={styles.selectAddressButton} onPress={handlePlaceOrder}>
      ...
      <Modal
        ...
        <View style={styles.orderModalOverlay}>
          <View style={styles.orderModal}>
            ...
            <ScrollView style={styles.orderModalContent}>
              {cartItems.map((item) => (
                <View key={item.id} style={styles.orderModalItem}>
                  <Image source={{uri: item.image}} style={styles.orderModalItemImage} />
                  <View style={styles.orderModalItemInfo}>
                    <Text style={styles.orderModalItemName}>{item.name}</Text>
                    <Text style={styles.orderModalItemPrice}>₹{item.price}</Text>
                  ...
                  <View style={styles.orderModalQuantity}>
                    ...
                    <Text style={styles.orderModalQuantityText}>{item.quantity}</Text>
                    <TouchableOpacity style={styles.orderModalQuantityButton}>
                      <Icon name="add" size={16} color="#1E40AF" />
                    </TouchableOpacity>
                  </View>
              ...
              <View style={styles.orderModalCoupons}>
                <Text style={styles.orderModalCouponsTitle}>Coupons & Offers</Text>
                <View style={styles.orderModalCouponItem}>
                  <View style={styles.orderModalCouponIcon}>
                    <Icon name="local-offer" size={16} color="#1E40AF" />
                  </View>
                  <Text style={styles.orderModalCouponText}>Save ₹20 with "TRYNEW"</Text>
                  <View style={styles.orderModalCouponApplied}>
                    <Text style={styles.orderModalCouponAppliedText}>APPLIED</Text>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.orderModalAddress}>
                <View style={styles.orderModalAddressHeader}>
                  <Text style={styles.orderModalAddressTitle}>DELIVERY ADDRESS</Text>
                  <TouchableOpacity>
                    <Text style={styles.orderModalAddressEdit}>EDIT</Text>
                  </TouchableOpacity>
                </View>
                <Text style={styles.orderModalAddressText}>House No.37, Harkat Nagar</Text>
              </View>
            ...
            {/* Bottom Button */}
            <TouchableOpacity style={styles.orderModalButton} onPress={handleProceedToAddress}>
